...
public class TileReceiver extends BroadcastReceiver {
    ...
    private PendingIntent createIntent(Context ctx, int i, Command command) {
        ...
        return activity ? PendingIntent.getActivity(ctx, i, intent, PendingIntent.FLAG_UPDATE_CURRENT) : PendingIntent.getBroadcast(ctx, i, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
